...
<Image
          ...
          <h1 className="text-[15px] text-center leading-[19px] font-semibold">{props.name}</h1>
          <p className="text-xs text-center text-[#788F9B] font-medium">{props.designation}</p>
          </div>
          </div>
