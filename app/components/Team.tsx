...
const Team = (props: Props) => {
  return (
    ...
    <div
      id="Team"
      className="bg-white w-full scroll-mt-14 gap-5 py-2 px-2 md:p-6 rounded-lg h-full relative flex flex-col"
    >
      <div className="w-full h-full relative   pb-2 flex flex-col gap-6">
        ...
        <div className="flex gap-2 flex-col">
          <>
            ...
            <p className="text-base mb-3 text-[#3E424A] font-medium leading-[26px]">
          ...
          <div className="flex w-full h-full justify-center items-center flex-col gap-6">
            ...
            <TeamsCard image={team2} name='Elina Williams' designation='Designation here' description='Lorem ipsum dolor sit amet consectetur. In justo rutrum sit sit fermentum ut libero hendrerit id. Tellus sit ornare netus sagittis in nunc convallis mattis maecenas. Tempus arcu leo sociis laoreet nec neque sed pellentesque viverra. Consectetur proin amet ut id facilisi quis consectetur. Tellus gravida ultricies feugiat sed eu egestas dolor est ipsum. Malesuada etiam mi gravida praesent interdu'/>
