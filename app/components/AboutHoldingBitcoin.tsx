...
const AboutHoldingBitcoin = (props: Props) => {
  return (
    ...
    <div id="Sentiments" className="bg-white w-full overflow-hidden gap-5  h-full relative flex flex-col">
...
<div className="flex w-full justify-center flex-col xl:flex-row gap-4 ">
    <AboutBitcoinCard image={bitcoin1} title='Calculate your Profit' button='Check Now'/>
