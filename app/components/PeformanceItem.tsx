...
const PeformanceItem = (props: Props) => {
  ...
  return (
    <div className=" flex border-b-[1px] border-[#D3E0E6] md:col-span-1 col-span-2 justify-between w-full py-3.5 px-2 ">
      <div className="w-fit basis-1/2 h-full text-sm font-medium text-[#768395] ">{props.heading}</div>
      <div className="h-full basis-1/2   flex flex-col font-medium text-[13px] text-right justify-end items-end  w-fit ">
